...
let peacock = 10
console.log(netflix, hulu, disneyPlus, youTubePremium, peacock)
...
if (total === newTotal){
    console.log(`The new total ${newTotal} is the same as the previous total ${total}`)
} else {
    console.log(`The new total ${newTotal} is not the same as the previous total ${total}`)
}
